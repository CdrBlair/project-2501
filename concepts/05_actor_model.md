...
**For understanding AI capabilities and limitations**: AI's inability to build theory—not just current technical limitations but fundamental inability to develop coherent understanding—explains why certain activities must remain human regardless of AI advancement. Theory building requires genuine engagement with problems that AI cannot replicate through pattern matching. This is not a temporary limitation but a fundamental difference in how humans and AI access and process knowledge.
...
**For recognising accountability requirements**: While capabilities can be provided by either human or AI actors, accountability can only rest with humans. Even if AI could technically make release decisions or accept risk, someone human must be accountable for outcomes. This means certain decision capabilities must remain human not because AI lacks technical ability but because accountability cannot be delegated to machines.

## Integration with Other Concepts

- **Information Composition Taxonomy**: Human actors can process all three knowledge types (formal, tacit, emergent). AI actors can only process formal knowledge. This asymmetry is the fundamental driver of appropriate actor selection—activities with high tacit or emergent composition require human actors.
- **Theory-Building Principle**: The distinction between humans building theory and AI matching patterns is the actor model's most critical asymmetry. This explains why certain activities must remain human even when AI technical capabilities advance—theory building is not a technical problem but a fundamental difference in knowledge access.
- **Eight-Capability Taxonomy**: Actor suitability is determined at the capability instance level by knowledge type, source type, and interaction mode — not by capability category. AI can elicit from systems but not unstated assumptions from stakeholders. AI can synthesise structured summaries but not novel understanding from ambiguous inputs. The capability taxonomy identifies what operation is needed; the knowledge type of the specific instance determines who should provide it.
- **Seven-Phase SDLC Model**: Different phases have different capability requirements and information compositions, thus benefiting from different actor mixes. Early phases require predominantly human actors due to high tacit content. Later phases enable more AI actor participation due to higher formal content.
- **Five Collaboration Patterns**: Concept 7 defines how human and AI actors work together. The patterns (Human-Only, Human-Led, Partnership, AI-Led, AI-Only) operationalise the actor model's insights about when each actor type should lead, support, or refrain from participation.
- **Phase-Specific Information Composition**: Phase composition determines appropriate actor mix—tacit-heavy phases need human actors, formal-heavy phases enable AI actors.
